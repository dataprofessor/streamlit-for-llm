...
st.set_page_config(page_title="Using hosted open source LLM models from Replicate", page_icon="3️⃣")

st.header("3️⃣ Using hosted open source LLM models from Replicate")
