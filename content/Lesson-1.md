...
|---|---|---|---|
| Chatbot | Build a generic chatbot or chatbot with a personality | <span style="color:red">`LLM`</span>, `Streamlit` | [App](https://llama2.streamlit.app/), [Blog](https://blog.streamlit.io/how-to-build-a-llama-2-chatbot/) |
